...
def test_unscheduled_values_contains_expected_placeholders() -> None:
...
def test_parse_days_expands_all_day_codes() -> None:
...
def test_parse_days_single_day() -> None:
    assert parse_days("T") == ["Tuesday"]


def test_parse_days_unknown_code_raises_key_error() -> None:
...
def test_parse_time_zero_pads_single_digit_hours() -> None:
    assert parse_time("9:00 AM - 9:50 AM") == ("09:00", "09:50")


def test_parse_time_converts_pm_hours_correctly() -> None:
    assert parse_time("1:00 PM - 2:15 PM") == ("13:00", "14:15")


def test_parse_time_handles_noon() -> None:
    assert parse_time("12:00 PM - 12:50 PM") == ("12:00", "12:50")


def test_parse_time_handles_midnight() -> None:
    assert parse_time("12:00 AM - 12:50 AM") == ("00:00", "00:50")


def test_parse_time_missing_separator_raises_value_error() -> None:
